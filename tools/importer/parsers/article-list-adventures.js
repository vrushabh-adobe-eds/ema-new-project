 ...
 *
 * The source shows every adventure as teaser cards (across tabs). Instead of
 * serializing them, emit a single config-only dynamic article-list that reads
 * the adventures query index and renders ALL adventures (no limit row). Any
 * static source cards inside the container are dropped.
 */
